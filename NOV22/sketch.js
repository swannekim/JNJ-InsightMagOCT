...
function draw() {
  ...
  if (pageNum == 0) {
    ...
    // month
    textSize(50);
    text("Nov, 2022", width * 0.54, height * 0.65);
...
*/
  ...
  if (pageNum == 10) {
    ...
    if (overRect(300, 335, 480, 120)) {
      push();
      stroke(1, 181, 226);
      strokeWeight(10);
      noFill();
      rect(300, 335, 480, 120);
      pop();
    } else {
      noStroke();
    }
    ...
    textSize(35);
    fill(225);
    text("↗ SharePoint", width * 0.5, height * 0.34);
...
function mousePressed() {
  ...
  if (
    ...
    window.open(
      "https://jnj.sharepoint.com/:f:/t/CON-TEAM-SHARED_12/conkr/CD/Eq0iVx9Dw3pLhvAh7sphNZEBeBI3MMAit5a1AIB3qyv9ng"
    );
  }
}
